...
public class HorariosProfessorConflitantes {
    ...
    private Disciplina disciplinaUm = new Disciplina("Calculo 1", 1, 110, 5);
    private Disciplina disciplinaDois = new Disciplina("Logica", 1, 110, 1);
    private Disciplina disciplinaTres = new Disciplina("Calculo 2", 2, 110, 1);
